...
\institute{\ \inst{1} Pleiad Lab, DCC, University of Chile, Santiago, Chile\\ \url{alexandre.bergel@me.com}\\
	\ \inst{2} Inria, France\\\url{damien.cassou@inria.fr}\\
...
%There was the first JSConf and JRubyConf this year.
...
\noindent \emph{Damien Cassou} is a postdoc working in the Arles
research group at Inria, France. Before that, he was a Ph.D. student
in France, supervised by Prof. Charles Consel of the Inria Phoenix
research group and then a postdoc in the Hasso--Plattner--Institute‘s
Software Architecture research group, lead by Prof. Dr. Robert
Hirschfeld. His Ph.D. thesis was about bringing general-purpose
programming tools to dedicated domains. To do that he designed a
domain-specific architecture description language whose compiler
produces dedicated programming frameworks in a general-purpose
programming language. Damien is also an active member of the Smalltalk
community.\\
